...
void func_812070A0(void) {
  ...
  n = D_812286EC / 8;
  if (n > 0) {
      for (p = D_81231450; p < &D_81231450[n]; p++) {
          p->unk_00 = 0;
          p->unk_04 = 0;
      }
  }
  ...
  q = D_81234650;
  for (i = ((u32)&D_81234700 - (u32)D_81234650) >> 3; i >= 0; i--) {
      q->unk_04 = 0;
      q->unk_00 = 0;
      q++;
  }
  ...
  D_81234690.unk_06 = (D_81234690.unk_02 / D_812346DC + 0xF) & ~0xF;
  D_81234690.unk_0A = D_81234690.unk_06 - 0x10;
  D_81234690.unk_08 = D_81234690.unk_06 + 0x10;

  for (r = &D_812346EC.unk_00; r < (s16*)&D_812346F2; r++) {
      *r = 0xA0;
  }
  ...
  t = D_812346E0;
  do {
      buf = (u16*)func_81207020(&D_81234680, 0xFC0);
      *t = buf;
      for (j = 0; j != 0x7E0; j++) {
          buf[j] = 0;
      }
      t++;
  } while (t != (void**)&D_812346EC);
}
#else
